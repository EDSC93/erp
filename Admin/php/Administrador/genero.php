				...
				<div class="row">				
					<div class="col-sm-6" >
						<div class="total_area">
							<form name="agregarSubcategoria" method="post" action="agregargenero.php">						
								<ul>
									<input type="text" value="" name="nombre" placeholder="Nombre del Genero" href="">
								</ul>								
									<input value="Agregar Genero" class="btn btn-default update" href="" type="submit"/>									
							</form>									
						</div>
					</div>
				</div>
