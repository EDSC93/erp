	...
	<!-- -->
		...
		<h4>Favor de modificar Imagen<h4>
			...
			?>
				...
				<form action="proceso_imagenproveedor.php?id=<?php echo  $re=$_GET['id']; ?>" method="POST" enctype="multipart/form-data">
					<input type="text" REQUIRED name="nombre" placeholder="Nombre..." value="<?php echo $f['Url_Imagen']; ?>"/><br/><br/>
					<img height="200px" src="../../../productos/proveedor/<?php echo $f['Url_Imagen']; ?>" /> <br/><br/>
					<input type="file" REQUIRED name="Imagen"/><br><br/>		
					<input type="submit" class="btn btn-primary" value="Cambiar">
				</form>

					<form method="POST" action="modificar_proveedor.php?id=<?php echo  $re=$_GET['id']; ?>">
			<br>
